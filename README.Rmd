...
<!-- badges: start -->
[![Travis build status](https://img.shields.io/travis/com/jakubsob/functiondepends.svg?logo=travis)](https://travis-ci.com/jakubsob/functiondepends)
[![AppVeyor build status](https://ci.appveyor.com/api/projects/status/github/jakubsob/functiondepends?branch=master&svg=true)](https://ci.appveyor.com/project/jakubsob/functiondepends)
